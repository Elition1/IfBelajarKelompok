...
public class AdminControl {
    @FXML
    private AnchorPane PanelDaftar, PanelTambah, PanelRemove, PanelRiwayat;
    ...
    @FXML
    void btnAddVehicle() {
        tampilPane(PanelTambah);
    }

    @FXML
    void btnRemoveVehicle() {
        tampilPane(PanelRemove);
    }

    @FXML
    void btnRiwayatTransaksi() {
        tampilPane(PanelRiwayat);
    }
